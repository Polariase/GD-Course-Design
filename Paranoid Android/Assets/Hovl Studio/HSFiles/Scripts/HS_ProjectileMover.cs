...
public class HS_ProjectileMover : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        if (!startChecker)
        {
            ...
            if (hitObj != null)
                hitPS = hitObj.GetComponent<ParticleSystem>();*/
            if (flash != null)
            {
    ...
    protected virtual void OnCollisionEnter(Collision collision)
    {
        ...
        //Spawn hitObj effect on collision
        if (hit != null)
        {
        ...
        //Removing trail from the projectile on cillision enter or smooth removing. detachedObj elements must have "AutoDestroying script"
